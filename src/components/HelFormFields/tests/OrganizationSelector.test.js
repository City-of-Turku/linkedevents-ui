...
describe('OrganizationSelector', () => {
    ...
    describe('renders', () => {
        test('label', () => {
            ...
            expect(label.prop('className')).toBe('event-publiser')
            expect(label.prop('htmlFor')).toBe('event-publiser')
        ...
        describe('when form type is update', () => {
            test('input', () => {
                ...
                expect(input.prop('className')).toBe('event-publiser-input')
                expect(input.prop('id')).toBe('event-publiser')
        ...
        describe('when form type is not update', () => {
            ...
            test('select input when there are more than one option', () => {
                ...
                expect(input.prop('className')).toBe('event-publiser-input')
                expect(input.prop('id')).toBe('event-publiser')
                expect(input.prop('name')).toBe('event-publiser')
